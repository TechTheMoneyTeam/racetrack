  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final bool hasTime = timeTrackingProvider.participantTimes.containsKey(bibNumber) && 
            currentSegment != null && 
            timeTrackingProvider.participantTimes[bibNumber]?.containsKey(currentSegment) == true;
            
        final DateTime? segmentTime = (hasTime && timeTrackingProvider.participantTimes[bibNumber]?[currentSegment] != null)
            ? timeTrackingProvider.participantTimes[bibNumber]![currentSegment]
            : null;
